...
<Columns cols={1}>
  <Card title="M2 工具使用 & Interleaved Thinking" icon="book-open" href="/guides/text-m2-function-call#openai-sdk" arrow="true" cta="点击查看">
    了解如何使用 MiniMax-M2.1 的工具调用和交错思考能力，提升模型在复杂任务中的表现。
  </Card>
</Columns>
...
<Columns cols={2}>
  ...
  <Card title="M2.1 工具使用 & Interleaved Thinking" icon="book-open" href="/guides/text-m2-function-call" arrow="true" cta="点击查看">
    工具使用让 AI 模型调用外部 API。
  </Card>
</Columns>
